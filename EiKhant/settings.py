"""
Django settings for EiKhant project.
...
SECRET_KEY = 'django-insecure--3slmacusu!^9vcuif@b(0ifa%sa*o@&vloi&jxy(y=p+cyou^'
...
WSGI_APPLICATION = 'EiKhant.wsgi.application'
